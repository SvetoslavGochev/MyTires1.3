namespace МоитеГуми.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public readonly IAnnouncementServices obqwi;
        ...
        {
            var latestObqwi = this.cache.Get<List<LatestAnnouncementServiseModel>>(LatestObqwiCacheKey);
